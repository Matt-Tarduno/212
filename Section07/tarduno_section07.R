...
# y_w, etc. are weighted vars. (tilde in the notes)
...
#   Why do we do this? Well these clusters are like blank stupid little dumb R's. 
#   They don't even know how to dplyr. Not a single work. So we gotta teach them. 
#   This can take up memory. 
...
#   Upshot: bad WLS can be terrible!
