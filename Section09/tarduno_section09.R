...
# Fancier way to make a table 
# "digits" gives number of decimal places 
# Can also use latex symbols! 
# This is in R-markdown 
...
# This is how to print code. Just get rid of the print if you want actual table. 
